  ...
  (function() {
    ...
    getStyle = function(element, styleName) {
      return (getStyle = hasFeature('ELEMENT_COMPUTED_STYLE')
    ...
    if (!hasFeature('ELEMENT_ADD_EVENT_LISTENER') && hasFeature('ELEMENT_DO_SCROLL')) {
    ...
    else if (hasFeature('ELEMENT_ADD_EVENT_LISTENER'))
